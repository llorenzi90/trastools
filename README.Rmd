...
The goal of trastools is to provide simple functions that help parsing info from transcriptome assembly files, such as GTF and tracking files from gffCompare.

## Installation

You can install the development version of trastools from [GitHub](https://github.com/) with:
